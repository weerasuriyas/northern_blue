            ...
            >
              ...
              <div className="p-5 md:p-6">
                ...
                <Link
                  ...
                  className="inline-block border border-nb-blue text-nb-blue text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-nb-blue hover:text-white transition-colors"
                >
                  Explore
                </Link>
              </div>
